...
export default function FounderSection() {
  return (
    <section className="relative z-[1] px-7 md:px-15 py-24 md:py-10">
      <div className="mx-auto flex max-w-[1280px] items-center gap-12 max-md:flex-col max-md:gap-10">
        <motion.div
        ...
        >
          ...
          <h2 className="font-heading text-[clamp(2rem,3.6vw,2.8rem)] font-extrabold leading-[1.1] tracking-tight mb-6">
            Waldir de{" "}
